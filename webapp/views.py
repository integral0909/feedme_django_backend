...
def recipe_react(request, recipe_id):
    try:
        ...
        return render(request, 'react_base.html', {'meta_img': static('images/og-image.jpg')})
    else:
...
def recipe_collection_react(request, slug):
    try:
        ...
        return render(request, 'react_base.html', {
            ...
            'meta_img_alt': collection.name, 'meta_description': collection.description
        })
...
def dish_detail(request, dish_id):
    ...
    return render(request, 'dish.html', {
            ...
            'uber': settings.UBER, 'meta_description': dish.description
        }
    )
